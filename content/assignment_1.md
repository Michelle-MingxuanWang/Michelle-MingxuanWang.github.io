Title: Assignment 1 Description
Date: 09/03/2021
Slug: Assignment 1 Description
...
In the "if" clause, the equations is "if $a\times 100+b\times 50+c\times 20+d\times 10+e\times 5+f\times 2<n+1$" because if the total amount is less than 201, the amount can be added to 200 with any number of 1 pence coins.
...
Therefore, let i, which is the number we need to find, starts from the square root of $10^18$ to the square root of $2\times 10^18$, which means it starts from $10^9$ to the square root of $2\times 10^9$.
